             ...
             <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview"
                 ...
                 <li class="nav-item">
                     <a href="{{ url('dashboard') }}"
                         class="nav-link {{ request()->is('admin/content/dashboard') ? 'active' : '' }}">
                 ...
                 <li class="nav-item">
                     <a href="{{ url('admin/content/kategori') }}"
                 ...
                 <li class="nav-item menu-open">
                     ...
                     <ul class="nav nav-treeview">
                         <li class="nav-item">
                             <a href=" {{ url('admin/content/pelanggan') }} "
                         ...
                         <li class="nav-item">
                             <a href=" {{ url('admin/content/supplier') }}  "
